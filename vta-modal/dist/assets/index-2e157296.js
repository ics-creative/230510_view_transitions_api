...
const TheHeader_vue_vue_type_style_index_0_scoped_1956c74f_lang = "";
...
const _sfc_main$5 = {};
const _withScopeId = (n) => (pushScopeId("data-v-1956c74f"), n = n(), popScopeId(), n);
const _hoisted_1$4 = { class: "header" };
const _hoisted_2$4 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("h1", null, "View Transitions API with Vue.js", -1));
const _hoisted_3$3 = [
  _hoisted_2$4
];
...
const TheHeader = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render], ["__scopeId", "data-v-1956c74f"]]);
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        createBaseVNode("div", _hoisted_2$3, toDisplayString(__props.item.date), 1),
        createBaseVNode("div", _hoisted_3$2, toDisplayString(__props.item.title), 1)
      ]);
    };
  }
});
const CardHeadline_vue_vue_type_style_index_0_scoped_f8c65941_lang = "";
const CardHeadline = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-f8c65941"]]);
const _hoisted_1$2 = {
  key: 0,
  class: "card"
};
const _hoisted_2$2 = ["data-card"];
const _hoisted_3$1 = { class: "card-thumb" };
...
const _hoisted_4 = { class: "modal-thumb" };
const _hoisted_5 = ["src"];
const _hoisted_6 = { class: "modal-description" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("div", _hoisted_2$1, [
          createBaseVNode("div", _hoisted_3, [
            ...
            createBaseVNode("p", _hoisted_6, toDisplayString(__props.item.description), 1)
          ]),
...
const ModalDialog_vue_vue_type_style_index_0_scoped_a425f6c5_lang = "";
const ModalDialog = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-a425f6c5"]]);
const items = [...Array(12).keys()].map((k) => ({
  id: k,
  date: "2023.03.04",
  title: "Flower",
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const openDialog = (item) => {
      const element = document.querySelector(`[data-card="${item.id}"]`);
      const img = element.querySelector("img");
      const title = element.querySelector(".headline");
    ...
    const closeDialog = () => {
      var _a;
      const id = ((_a = selectedItem.value) == null ? void 0 : _a.id) ?? "";
      transitionHelper({
        async updateDOM() {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", {
          class: "table",
          inert: isModalOpen.value
        }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(items), (item, index) => {
            var _a, _b;
            return openBlock(), createElementBlock(Fragment, null, [
              index % 2 === 0 ? (openBlock(), createElementBlock("div", {
                key: 0,
                ...
                createVNode(CardItem, {
                  item: unref(items)[index],
                  onOpen: openDialog,
                  selected: ((_a = selectedItem.value) == null ? void 0 : _a.id) === unref(items)[index].id
                }, null, 8, ["item", "selected"]),
                createVNode(CardItem, {
                  item: unref(items)[index + 1],
                  onOpen: openDialog,
                  selected: ((_b = selectedItem.value) == null ? void 0 : _b.id) === unref(items)[index + 1].id
                }, null, 8, ["item", "selected"])
              ], 2)) : createCommentVNode("", true)
            ], 64);
          }), 256))
        ], 8, _hoisted_2),
        selectedItem.value != null ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          isModalOpen.value ? (openBlock(), createBlock(ModalDialog, {
            key: 0,
...
const CardPage_vue_vue_type_style_index_0_scoped_4de1fd9a_lang = "";
const CardPage = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-4de1fd9a"]]);
